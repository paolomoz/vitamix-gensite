/**
 * Demo Examples - 6 pre-configured intent inference scenarios
 * Based on: Generative Websites: Intent Inference Use Cases
 */
...
export const demoExamples = [
  ...
  // ============================================
  {
    ...
    queryMapping: [
      { component: 'Intent', source: 'search: baby food blender', phrase: 'to make baby food' },
      { component: 'Context', source: 'segments: new_parent', phrase: '(implied by use case)' },
      { component: 'Action', source: 'confidence: 0.52 (moderate)', phrase: 'What do you recommend?' },
    ],
    generatedExperience: {
      headline: 'Fresh, homemade baby food in seconds',
      features: ['Baby food recipes', 'Puree techniques', 'BPA-free containers', 'Easy cleaning'],
    },
  },

  {
    ...
    queryMapping: [
      { component: 'Intent', source: 'use_cases: baby_food, purees', phrase: 'make homemade baby food and purees' },
      { component: 'Context', source: 'segments: new_parent', phrase: 'for my baby' },
      { component: 'Products', source: 'products_considered: E310', phrase: "I've been looking at the E310" },
      { component: 'Content', source: 'content_engagement: high', phrase: 'reading through baby food recipes' },
      { component: 'Constraints', source: 'price_sensitivity: high', phrase: "I'm on a budget" },
      { component: 'Qualifier', source: 'segments: first_time_buyer', phrase: 'this would be my first Vitamix' },
      { component: 'Action', source: 'confidence: 0.78 (high)', phrase: 'Is the E310 the right choice...?' },
    ],
    generatedExperience: {
      headline: 'Everything you need for homemade baby food',
      features: ['E310 vs. store-bought savings calculator', 'BPA-free certification', 'Parent reviews', 'First 10 recipes guide', 'Storage containers'],
    },
  },
  ...
  // ============================================
  {
    ...
    queryMapping: [
      { component: 'Intent', source: 'use_cases: gift', phrase: 'as a wedding gift' },
      { component: 'Context', source: 'occasion: wedding', phrase: 'wedding' },
      { component: 'Products', source: 'compare_tool: [X5, X4]', phrase: "I'm comparing the X5 and X4" },
      { component: 'Action', source: 'decision_style: efficient', phrase: 'Which one makes a better gift?' },
    ],
    generatedExperience: {
      headline: "The gift they'll use every day for years",
      features: ['Premium packaging', '10-year warranty', 'Wow factor', 'Ships gift-ready'],
    },
  },

  {
    ...
    queryMapping: [
      { component: 'Intent', source: 'use_cases: gift', phrase: 'as a wedding gift' },
      { component: 'Context', source: 'occasion: wedding + premium_preference', phrase: 'premium + impressive' },
      { component: 'Products', source: 'products_considered: [X5, A3500]', phrase: "I'm comparing the X5 and A3500" },
      { component: 'Presentation', source: 'content_engagement: low (skipped recipes)', phrase: 'looks great when they open it' },
      { component: 'Time constraint', source: 'time_sensitive: true', phrase: 'I need it to arrive soon' },
      { component: 'Risk mitigation', source: 'return_policy_viewed: true', phrase: 'can return it easily if they already have one' },
      { component: 'Action', source: 'purchase_readiness: high', phrase: 'Which should I choose?' },
    ],
    generatedExperience: {
      headline: "The wedding gift they'll never forget",
      features: ['X5 vs A3500 comparison', 'Unboxing experience', 'Easy returns', 'Estimated arrival date', 'Gift wrap option'],
    },
  },
  ...
  // ============================================
  {
    ...
    queryMapping: [
      { component: 'Intent', source: 'use_cases: upgrade', phrase: 'upgrade' },
      { component: 'Context', source: 'segments: existing_owner', phrase: 'my old Vitamix' },
      { component: 'Action', source: 'confidence: 0.58 (moderate)', phrase: 'What are my options?' },
    ],
    generatedExperience: {
      headline: 'Your next Vitamix is waiting',
      features: ["What's new in latest models", 'Feature comparison to legacy', 'Accessory compatibility'],
    },
  },

  {
    ...
    queryMapping: [
      { component: 'Current state', source: 'current_product: 5200_series_likely', phrase: 'I have a Vitamix 5200' },
      { component: 'Intent', source: 'use_cases: feature_upgrade', phrase: 'upgrade to something with more modern features' },
      { component: 'Products', source: 'products_considered: [X5, Recon A3500]', phrase: 'comparing the new X5 with a reconditioned A3500' },
      { component: 'Accessories', source: 'accessory_owner: true', phrase: "containers and accessories I'd like to keep using" },
      { component: 'Value', source: 'segments: value_conscious', phrase: 'I want good value' },
      { component: 'Features', source: 'category_view: ascent-series', phrase: 'smart features' },
      { component: 'Action', source: 'confidence: 0.85 (high)', phrase: "What's the best upgrade path for me?" },
    ],
    generatedExperience: {
      headline: "Upgrade your Vitamix: What's changed since the 5200",
      features: ['Smart features comparison', 'Container compatibility', 'Certified Reconditioned value', '5200 → X5 upgrade benefits', 'Trade-in program'],
    },
  },
];
