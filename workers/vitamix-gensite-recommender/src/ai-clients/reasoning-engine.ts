...
${signalInterpretation ? `
## DIRECT SIGNAL INTERPRETATION (HIGH PRIORITY - from browsing behavior analysis)
This interpretation was generated by analyzing the user's raw browsing signals directly.
It provides deeper insight than rule-based profile matching.

**Primary Intent**: ${signalInterpretation.interpretation.primaryIntent}
...
### Content Recommendations from Signal Analysis
**Hero Tone**: ${signalInterpretation.contentRecommendation.heroTone}
**Prioritize Blocks**: ${signalInterpretation.contentRecommendation.prioritizeBlocks.join(', ') || 'None specified'}
**Avoid Blocks**: ${signalInterpretation.contentRecommendation.avoidBlocks.join(', ') || 'None specified'}
**Special Guidance**: ${signalInterpretation.contentRecommendation.specialGuidance || 'None'}

IMPORTANT: Use this signal interpretation to guide your block selection and content guidance.
The "Primary Intent" and "Specific Needs" should be reflected in the blocks you choose.
The "Hero Tone" should influence how you write the hero block's contentGuidance.
` : ''}
