...
const ANALYZED_IMAGES: Record<string, ImageAnalysis> = {
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-nice-cream-bowl.png': {
    ...
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for nice cream bowl category, subject on left',
    text_placement: 'right',
    background_tone: 'light',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-frozen-fruit-sorbet.png': {
    ...
    dominant_colors: ['orange', 'pink', 'black'],
    mood: 'vibrant',
    content_description: 'Vibrant mango and raspberry sorbet scoops in clear glass dessert bowl with fresh mint garnish, dark background',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for frozen fruit sorbet category, subject center-left with dark space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of vibrant mango and raspberry sorbet scoops in a clear glass dessert bowl. Bowl positioned on the RIGHT SIDE of frame with fresh mint garnish and scattered berries. Large empty dark gradient space on the LEFT SIDE for text overlay. Bright, clean studio lighting with warm highlights. Editorial food magazine style. Wide 16:9 composition. No appliances visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-chocolate-ice-cream.png': {
    ...
    dominant_colors: ['brown', 'black', 'red'],
    mood: 'indulgent',
    content_description: 'Rich dark chocolate frozen dessert in elegant white bowl with chocolate shavings and fresh raspberries on dark background',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for chocolate ice cream category, subject center-left with dark space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-tropical-frozen-cocktail.png': {
    ...
    dominant_colors: ['orange', 'pink', 'black'],
    mood: 'tropical',
    content_description: 'Colorful layered frozen tropical drink in tall hurricane glass with pineapple wedge and cherry garnish on dark background',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for tropical frozen cocktail category, subject center-left with dark space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-hummus-platter.png': {
    ...
    dominant_colors: ['beige', 'orange', 'terracotta'],
    mood: 'warm',
    content_description: 'Creamy golden hummus in ceramic bowl with olive oil drizzle and paprika, positioned on left with vegetables, terracotta background',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for hummus platter category, subject on left with clear space on right',
    text_placement: 'right',
    background_tone: 'mixed',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of creamy golden hummus in ceramic bowl with olive oil drizzle and paprika. Bowl positioned on the LEFT SIDE of frame with fresh vegetables (cucumber, carrots, bell peppers) arranged to the left. Large empty negative space on the RIGHT SIDE for text overlay. Warm terracotta surface, Mediterranean styling. Soft natural lighting. Wide 16:9 aspect ratio. No kitchen appliances.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-fresh-pesto.png': {
    ...
    dominant_colors: ['green', 'brown', 'dark gray'],
    mood: 'rustic',
    content_description: 'Vibrant green basil pesto in white marble mortar positioned on left with ingredients, dark wooden background on right',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for fresh pesto category, subject on left with dark wood space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-vibrant-green-smoothie.png': {
    ...
    mood: 'healthy',
    content_description: 'Bright green spinach kale smoothie in tall clear glass positioned center-right with fresh greens, dark background with space on left',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for vibrant green smoothie category, subject center-right with dark space on left',
    text_placement: 'left',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional beverage photography of bright green spinach kale smoothie in tall clear glass with glass straw. Glass positioned on the RIGHT SIDE of frame with fresh spinach leaves, kale, and apple slices arranged nearby on the right. Large empty dark space on the LEFT SIDE for text overlay. Clean, healthy aesthetic with bright natural lighting. Wide 16:9 composition. No blender visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-detox-green-juice.png': {
    ...
    dominant_colors: ['green', 'white', 'light gray'],
    mood: 'healthy',
    content_description: 'Vibrant green juice in mason jar positioned center-left with fresh vegetables, light gray background with space on right',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for detox green juice category, subject center-left with light space on right',
    text_placement: 'right',
    background_tone: 'light',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of vibrant green juice in mason jar with cucumber slice on rim. Jar positioned on the LEFT SIDE of frame with fresh celery, cucumber, green apple, and lemon arranged nearby on the left. Large empty light grey/white space on the RIGHT SIDE for text overlay. Bright white background, clean healthy mood. Morning light feel. Wide format. No appliances visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-acai-bowl.png': {
    ...
    dominant_colors: ['purple', 'white', 'beige'],
    mood: 'energizing',
    content_description: 'Purple acai smoothie bowl topped with sliced banana, fresh berries, granola, positioned on right with light wooden space on left',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for acai bowl category, subject on right with light space on left',
    text_placement: 'left',
    background_tone: 'light',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of purple acai smoothie bowl topped with sliced banana, fresh berries, granola, coconut flakes, and chia seeds. White ceramic bowl positioned on the RIGHT SIDE of frame on light wooden board. Large empty white/cream space on the LEFT SIDE for text overlay. Bright, healthy morning mood. Clean composition, wide 16:9 format. No kitchen appliances visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-overnight-oats.png': {
    ...
    dominant_colors: ['beige', 'black', 'red'],
    mood: 'cozy',
    content_description: 'Creamy overnight oats in glass jar positioned center-left with berries, dark background with some space on sides',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for overnight oats category, subject center-left with dark space available',
    text_placement: 'left',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-baby-purees.png': {
    ...
    dominant_colors: ['orange', 'green', 'mint'],
    mood: 'nurturing',
    content_description: 'Three small glass jars containing colorful baby food purees positioned on right with fresh vegetables, mint background with clear space on left',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for baby purees category, subject on right with clear space on left',
    text_placement: 'left',
    background_tone: 'light',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-juice-bar-drinks.png': {
    ...
    dominant_colors: ['green', 'orange', 'black'],
    mood: 'energetic',
    content_description: 'Colorful fresh juice lineup positioned on left with fresh fruits, dark background with clear space on right',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for juice bar drinks category, subject on left with dark space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of colorful fresh juice lineup - green, orange, red, purple juices in clear bottles. Bottles arranged in a diagonal line on the LEFT SIDE of frame with fresh fruits nearby. Large empty dark gradient space on the RIGHT SIDE for text overlay. Bright, energetic mood. Clean counter surface, commercial presentation style. Wide 16:9 format. No blenders or equipment visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-restaurant-soup.png': {
    ...
    mood: 'sophisticated',
    content_description: 'Elegant butternut squash soup in white fine dining bowl positioned on right with dark slate, clear dark space on left',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for restaurant soup category, subject on right with dark space on left',
    text_placement: 'left',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
  ...
  'https://vitamix-gensite-recommender.paolo-moz.workers.dev/hero-images/hero-pumpkin-soup.png': {
    ...
    dominant_colors: ['orange', 'brown', 'dark brown'],
    mood: 'cozy',
    content_description: 'Creamy pumpkin soup in rustic ceramic bowl positioned on left with pepita seeds, decorative pumpkins behind, dark brown space on right',
    quality_score: 8,
    hero_suitable: true,
    hero_notes: 'AI-generated image for pumpkin soup category, subject on left with dark space on right',
    text_placement: 'right',
    background_tone: 'dark',
    aspect_ratio: 'wide',
    source: 'generated',
    generated_prompt: 'Professional food photography of creamy pumpkin soup in rustic ceramic bowl with pepita seeds and sage garnish. Bowl positioned on the LEFT SIDE of frame with small decorative pumpkins behind it on the left. Large empty dark brown/moody space on the RIGHT SIDE for text overlay. Warm, cozy fall aesthetic with golden lighting. Wide horizontal composition. No appliances visible.',
    generated_at: '2026-01-18T00:00:00.000Z',
  },
};
